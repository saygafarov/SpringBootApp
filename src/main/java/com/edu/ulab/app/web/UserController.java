...
public class UserController {
    ...
    @Operation(summary = "Update user with books for request.",
            responses = {@ApiResponse(description = "User book",
                    content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
                            schema = @Schema(implementation = UserBookResponse.class)))})
    public UserBookResponse getUserWithBooks(@RequestBody UpdateUserBookRequest request) {
        log.info("Got request user and his books: {}", request);
    ...
    @Operation(summary = "Get user with books at user id.",
            responses = {@ApiResponse(description = "User book",
                    content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
                            schema = @Schema(implementation = UserBookResponse.class)))})
